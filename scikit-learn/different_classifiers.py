...
if __name__ == '__main__':
    ...
    t2 = time.time()
    calc_accuracy(estimated_classes, test_labels, 'KNN Classifier with k = 1', t2-t1)
    ...
    estimated_classes = knn_classifier.predict(test_data)
    t2 = time.time()
    calc_accuracy(estimated_classes, test_labels, 'KNN Classifier with k = 5', t2 - t1)
    ...
    estimated_classes = knn_classifier.predict(test_data)
    t2 = time.time()
    calc_accuracy(estimated_classes, test_labels, 'KNN Classifier with k = 10', t2 - t1)
